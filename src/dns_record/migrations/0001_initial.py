# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-02-15 12:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain', models.CharField(help_text='Required. Domain Name', max_length=255, verbose_name='Domain Name')),
                ('status', models.BooleanField(help_text='Whether Domains NS record points to our NS', verbose_name='Status of the Domain')),
        ...
        migrations.AddField(
            ...
            name='domain',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dns_record.Domain'),
        ),
    ]
